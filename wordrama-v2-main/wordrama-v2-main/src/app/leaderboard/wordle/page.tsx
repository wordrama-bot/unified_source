...
export default function WordleAllTimeLeaderboardPage() {
  ...
  //getAppInsights().trackPageView({ name: 'Wordle Leaderboard' });
        ...
        <Card className="w-full max-w-6xl mx-auto bg-bg text-text dark:bg-darkBg dark:text-darkText">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              { allTimeTop3Data?.data?.slice(0, 3).map((player, index) => (
                    ...
                    <HoverCardTrigger asChild>
                      <CardContent className="pt-6">
                        ...
                        <div className="mt-2 text-sm text-muted-foreground">
                          ...
                          <p>Best Streak: {prefix ? player[`${prefix}BestStreak`] : player.overallBestStreak}</p>
                        </div>
                      </CardContent>
                    </HoverCardTrigger>
                    <HoverCardContent className="w-80">
                      <div className="flex justify-between space-x-4">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-sm">
                            <span className="font-semibold">Coins:</span> { player.coinBalance }
                          </p>
                        </div>
                      </div>
                    </HoverCardContent>
