...
export default function WordleWeeklyLeaderboardPage() {
  ...
  useEffect(() => {
    ...
    setLeaderboardData({ data: [] });
  }, [weeklyData, weeklyError, sortByKey]);
