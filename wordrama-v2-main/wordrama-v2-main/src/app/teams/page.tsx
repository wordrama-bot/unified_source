        ...
        <div className="mx-auto grid w-full max-w-6xl gap-2">
          <h1 className="text-3xl text-text dark:text-darkText font-semibold">Teams</h1>
            <p className="text-sm text-muted-foreground max-w-3xl">
              Teams let Wordrama players join communities, compete together, and compare leaderboard stats. Browse active teams below, open a team page to view members and stats, or join a team.
            </p>
        </div>
