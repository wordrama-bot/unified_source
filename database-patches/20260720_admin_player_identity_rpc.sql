-- Returns forwarded-IP evidence and potentially related accounts for one player.
--
-- The function relies on the audit expression indexes created by:
--   20260720_admin_player_identity_indexes.sql
--   20260720_optimize_admin_identity_ip_history.sql
