create or replace view public._v_wordle_daily_stats as
 SELECT r.day,
    ...
    sum(
        CASE
            WHEN r.word_pack = 'FOUR_LETTER' AND r.word_length = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS four_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'FOUR_LETTER' AND r.word_length = 4 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS four_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'FOUR_LETTER' AND r.word_length = 4 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS four_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'FOUR_LETTER' AND r.word_length = 4 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS four_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'FOUR_LETTER' AND r.word_length = 4 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS four_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'FOUR_LETTER' AND r.word_length = 4 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS four_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'FOUR_LETTER' AND r.word_length = 4 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS four_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'FOUR_LETTER' AND r.word_length = 4 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
    ...
    sum(
        CASE
            WHEN r.word_pack = 'SIX_LETTER' AND r.word_length = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS six_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'SIX_LETTER' AND r.word_length = 6 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS six_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'SIX_LETTER' AND r.word_length = 6 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS six_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'SIX_LETTER' AND r.word_length = 6 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS six_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'SIX_LETTER' AND r.word_length = 6 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS six_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'SIX_LETTER' AND r.word_length = 6 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS six_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'SIX_LETTER' AND r.word_length = 6 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS six_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'SIX_LETTER' AND r.word_length = 6 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS six_letter_games_won_in_6,
    sum(
        CASE
            WHEN r.word_pack = 'SEVEN_LETTER' AND r.word_length = 7 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS seven_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'SEVEN_LETTER' AND r.word_length = 7 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS seven_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'SEVEN_LETTER' AND r.word_length = 7 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS seven_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'SEVEN_LETTER' AND r.word_length = 7 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS seven_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'SEVEN_LETTER' AND r.word_length = 7 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS seven_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'SEVEN_LETTER' AND r.word_length = 7 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS seven_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'SEVEN_LETTER' AND r.word_length = 7 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS seven_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'SEVEN_LETTER' AND r.word_length = 7 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS seven_letter_games_won_in_6,
    sum(
        CASE
            WHEN r.word_pack = 'EIGHT_LETTER' AND r.word_length = 8 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eight_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'EIGHT_LETTER' AND r.word_length = 8 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS eight_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'EIGHT_LETTER' AND r.word_length = 8 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eight_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'EIGHT_LETTER' AND r.word_length = 8 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eight_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'EIGHT_LETTER' AND r.word_length = 8 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eight_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'EIGHT_LETTER' AND r.word_length = 8 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eight_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'EIGHT_LETTER' AND r.word_length = 8 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eight_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'EIGHT_LETTER' AND r.word_length = 8 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eight_letter_games_won_in_6,
    sum(
        CASE
            WHEN r.word_pack = 'NINE_LETTER' AND r.word_length = 9 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS nine_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'NINE_LETTER' AND r.word_length = 9 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS nine_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'NINE_LETTER' AND r.word_length = 9 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS nine_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'NINE_LETTER' AND r.word_length = 9 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS nine_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'NINE_LETTER' AND r.word_length = 9 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS nine_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'NINE_LETTER' AND r.word_length = 9 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS nine_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'NINE_LETTER' AND r.word_length = 9 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS nine_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'NINE_LETTER' AND r.word_length = 9 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS nine_letter_games_won_in_6,
    sum(
        CASE
            WHEN r.word_pack = 'TEN_LETTER' AND r.word_length = 10 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS ten_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'TEN_LETTER' AND r.word_length = 10 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS ten_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'TEN_LETTER' AND r.word_length = 10 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS ten_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'TEN_LETTER' AND r.word_length = 10 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS ten_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'TEN_LETTER' AND r.word_length = 10 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS ten_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'TEN_LETTER' AND r.word_length = 10 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS ten_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'TEN_LETTER' AND r.word_length = 10 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS ten_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'TEN_LETTER' AND r.word_length = 10 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS ten_letter_games_won_in_6,
    sum(
        CASE
            WHEN r.word_pack = 'ELEVEN_LETTER' AND r.word_length = 11 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eleven_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'ELEVEN_LETTER' AND r.word_length = 11 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS eleven_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'ELEVEN_LETTER' AND r.word_length = 11 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eleven_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'ELEVEN_LETTER' AND r.word_length = 11 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eleven_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'ELEVEN_LETTER' AND r.word_length = 11 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eleven_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'ELEVEN_LETTER' AND r.word_length = 11 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eleven_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'ELEVEN_LETTER' AND r.word_length = 11 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eleven_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'ELEVEN_LETTER' AND r.word_length = 11 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eleven_letter_games_won_in_6,
    sum(
        CASE
            WHEN r.word_pack = 'TWELVE_LETTER' AND r.word_length = 12 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twelve_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'TWELVE_LETTER' AND r.word_length = 12 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS twelve_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'TWELVE_LETTER' AND r.word_length = 12 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twelve_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'TWELVE_LETTER' AND r.word_length = 12 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twelve_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'TWELVE_LETTER' AND r.word_length = 12 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twelve_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'TWELVE_LETTER' AND r.word_length = 12 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twelve_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'TWELVE_LETTER' AND r.word_length = 12 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twelve_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'TWELVE_LETTER' AND r.word_length = 12 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twelve_letter_games_won_in_6,
    sum(
        CASE
            WHEN r.word_pack = 'THIRTEEN_LETTER' AND r.word_length = 13 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS thirteen_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'THIRTEEN_LETTER' AND r.word_length = 13 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS thirteen_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'THIRTEEN_LETTER' AND r.word_length = 13 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS thirteen_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'THIRTEEN_LETTER' AND r.word_length = 13 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS thirteen_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'THIRTEEN_LETTER' AND r.word_length = 13 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS thirteen_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'THIRTEEN_LETTER' AND r.word_length = 13 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS thirteen_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'THIRTEEN_LETTER' AND r.word_length = 13 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS thirteen_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'THIRTEEN_LETTER' AND r.word_length = 13 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS thirteen_letter_games_won_in_6,
    sum(
        CASE
            WHEN r.word_pack = 'FOURTEEN_LETTER' AND r.word_length = 14 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS fourteen_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'FOURTEEN_LETTER' AND r.word_length = 14 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS fourteen_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'FOURTEEN_LETTER' AND r.word_length = 14 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS fourteen_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'FOURTEEN_LETTER' AND r.word_length = 14 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS fourteen_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'FOURTEEN_LETTER' AND r.word_length = 14 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS fourteen_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'FOURTEEN_LETTER' AND r.word_length = 14 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS fourteen_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'FOURTEEN_LETTER' AND r.word_length = 14 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS fourteen_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'FOURTEEN_LETTER' AND r.word_length = 14 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS fourteen_letter_games_won_in_6,
    sum(
        CASE
            WHEN r.word_pack = 'FIFTEEN_LETTER' AND r.word_length = 15 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS fifteen_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'FIFTEEN_LETTER' AND r.word_length = 15 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS fifteen_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'FIFTEEN_LETTER' AND r.word_length = 15 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS fifteen_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'FIFTEEN_LETTER' AND r.word_length = 15 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS fifteen_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'FIFTEEN_LETTER' AND r.word_length = 15 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS fifteen_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'FIFTEEN_LETTER' AND r.word_length = 15 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS fifteen_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'FIFTEEN_LETTER' AND r.word_length = 15 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS fifteen_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'FIFTEEN_LETTER' AND r.word_length = 15 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS fifteen_letter_games_won_in_6,
    sum(
        CASE
            WHEN r.word_pack = 'SIXTEEN_LETTER' AND r.word_length = 16 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS sixteen_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'SIXTEEN_LETTER' AND r.word_length = 16 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS sixteen_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'SIXTEEN_LETTER' AND r.word_length = 16 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS sixteen_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'SIXTEEN_LETTER' AND r.word_length = 16 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS sixteen_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'SIXTEEN_LETTER' AND r.word_length = 16 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS sixteen_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'SIXTEEN_LETTER' AND r.word_length = 16 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS sixteen_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'SIXTEEN_LETTER' AND r.word_length = 16 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS sixteen_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'SIXTEEN_LETTER' AND r.word_length = 16 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS sixteen_letter_games_won_in_6,
    sum(
        CASE
            WHEN r.word_pack = 'SEVENTEEN_LETTER' AND r.word_length = 17 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS seventeen_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'SEVENTEEN_LETTER' AND r.word_length = 17 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS seventeen_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'SEVENTEEN_LETTER' AND r.word_length = 17 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS seventeen_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'SEVENTEEN_LETTER' AND r.word_length = 17 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS seventeen_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'SEVENTEEN_LETTER' AND r.word_length = 17 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS seventeen_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'SEVENTEEN_LETTER' AND r.word_length = 17 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS seventeen_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'SEVENTEEN_LETTER' AND r.word_length = 17 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS seventeen_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'SEVENTEEN_LETTER' AND r.word_length = 17 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS seventeen_letter_games_won_in_6,
    sum(
        CASE
            WHEN r.word_pack = 'EIGHTEEN_LETTER' AND r.word_length = 18 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eighteen_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'EIGHTEEN_LETTER' AND r.word_length = 18 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS eighteen_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'EIGHTEEN_LETTER' AND r.word_length = 18 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eighteen_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'EIGHTEEN_LETTER' AND r.word_length = 18 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eighteen_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'EIGHTEEN_LETTER' AND r.word_length = 18 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eighteen_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'EIGHTEEN_LETTER' AND r.word_length = 18 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eighteen_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'EIGHTEEN_LETTER' AND r.word_length = 18 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eighteen_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'EIGHTEEN_LETTER' AND r.word_length = 18 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS eighteen_letter_games_won_in_6,
    sum(
        CASE
            WHEN r.word_pack = 'NINETEEN_LETTER' AND r.word_length = 19 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS nineteen_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'NINETEEN_LETTER' AND r.word_length = 19 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS nineteen_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'NINETEEN_LETTER' AND r.word_length = 19 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS nineteen_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'NINETEEN_LETTER' AND r.word_length = 19 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS nineteen_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'NINETEEN_LETTER' AND r.word_length = 19 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS nineteen_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'NINETEEN_LETTER' AND r.word_length = 19 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS nineteen_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'NINETEEN_LETTER' AND r.word_length = 19 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS nineteen_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'NINETEEN_LETTER' AND r.word_length = 19 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS nineteen_letter_games_won_in_6,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTY_LETTER' AND r.word_length = 20 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twenty_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTY_LETTER' AND r.word_length = 20 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS twenty_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTY_LETTER' AND r.word_length = 20 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twenty_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTY_LETTER' AND r.word_length = 20 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twenty_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTY_LETTER' AND r.word_length = 20 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twenty_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTY_LETTER' AND r.word_length = 20 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twenty_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTY_LETTER' AND r.word_length = 20 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twenty_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTY_LETTER' AND r.word_length = 20 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twenty_letter_games_won_in_6,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYONE_LETTER' AND r.word_length = 21 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentyone_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYONE_LETTER' AND r.word_length = 21 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS twentyone_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYONE_LETTER' AND r.word_length = 21 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentyone_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYONE_LETTER' AND r.word_length = 21 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentyone_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYONE_LETTER' AND r.word_length = 21 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentyone_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYONE_LETTER' AND r.word_length = 21 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentyone_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYONE_LETTER' AND r.word_length = 21 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentyone_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYONE_LETTER' AND r.word_length = 21 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentyone_letter_games_won_in_6,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYTWO_LETTER' AND r.word_length = 22 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentytwo_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYTWO_LETTER' AND r.word_length = 22 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS twentytwo_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYTWO_LETTER' AND r.word_length = 22 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentytwo_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYTWO_LETTER' AND r.word_length = 22 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentytwo_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYTWO_LETTER' AND r.word_length = 22 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentytwo_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYTWO_LETTER' AND r.word_length = 22 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentytwo_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYTWO_LETTER' AND r.word_length = 22 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentytwo_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYTWO_LETTER' AND r.word_length = 22 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentytwo_letter_games_won_in_6,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYTHREE_LETTER' AND r.word_length = 23 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentythree_letter_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYTHREE_LETTER' AND r.word_length = 23 AND r.game_was_won = false THEN 1
            ELSE 0
        END) AS twentythree_letter_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYTHREE_LETTER' AND r.word_length = 23 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentythree_letter_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYTHREE_LETTER' AND r.word_length = 23 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentythree_letter_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYTHREE_LETTER' AND r.word_length = 23 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentythree_letter_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYTHREE_LETTER' AND r.word_length = 23 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentythree_letter_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYTHREE_LETTER' AND r.word_length = 23 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END) AS twentythree_letter_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'TWENTYTHREE_LETTER' AND r.word_length = 23 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
    ...
    sum(
        CASE
            WHEN r.word_pack = 'ELEVEN_LETTER_EXTENDED' AND r.word_length = 11 AND r.game_was_won = true THEN 1
            ELSE 0
        END
    ) AS eleven_letter_extended_games_won,
    sum(
        CASE
            WHEN r.word_pack = 'ELEVEN_LETTER_EXTENDED' AND r.word_length = 11 AND r.game_was_won = false THEN 1
            ELSE 0
        END
    ) AS eleven_letter_extended_games_lost,
    sum(
        CASE
            WHEN r.word_pack = 'ELEVEN_LETTER_EXTENDED' AND r.word_length = 11 AND r.guess_count = 1 AND r.game_was_won = true THEN 1
            ELSE 0
        END
    ) AS eleven_letter_extended_games_won_in_1,
    sum(
        CASE
            WHEN r.word_pack = 'ELEVEN_LETTER_EXTENDED' AND r.word_length = 11 AND r.guess_count = 2 AND r.game_was_won = true THEN 1
            ELSE 0
        END
    ) AS eleven_letter_extended_games_won_in_2,
    sum(
        CASE
            WHEN r.word_pack = 'ELEVEN_LETTER_EXTENDED' AND r.word_length = 11 AND r.guess_count = 3 AND r.game_was_won = true THEN 1
            ELSE 0
        END
    ) AS eleven_letter_extended_games_won_in_3,
    sum(
        CASE
            WHEN r.word_pack = 'ELEVEN_LETTER_EXTENDED' AND r.word_length = 11 AND r.guess_count = 4 AND r.game_was_won = true THEN 1
            ELSE 0
        END
    ) AS eleven_letter_extended_games_won_in_4,
    sum(
        CASE
            WHEN r.word_pack = 'ELEVEN_LETTER_EXTENDED' AND r.word_length = 11 AND r.guess_count = 5 AND r.game_was_won = true THEN 1
            ELSE 0
        END
    ) AS eleven_letter_extended_games_won_in_5,
    sum(
        CASE
            WHEN r.word_pack = 'ELEVEN_LETTER_EXTENDED' AND r.word_length = 11 AND r.guess_count = 6 AND r.game_was_won = true THEN 1
            ELSE 0
        END
    ) AS eleven_letter_extended_games_won_in_6
...
create or replace view public._v_wordle_weekly_stats as 
   SELECT _v_wordle_daily_stats.player,
    ...
    sum(_v_wordle_daily_stats.eleven_letter_extended_games_won) AS eleven_letter_extended_games_won,
    sum(_v_wordle_daily_stats.eleven_letter_extended_games_lost) AS eleven_letter_extended_games_lost,
    sum(_v_wordle_daily_stats.eleven_letter_extended_games_won_in_1) AS eleven_letter_extended_games_won_in_1,
    sum(_v_wordle_daily_stats.eleven_letter_extended_games_won_in_2) AS eleven_letter_extended_games_won_in_2,
    sum(_v_wordle_daily_stats.eleven_letter_extended_games_won_in_3) AS eleven_letter_extended_games_won_in_3,
    sum(_v_wordle_daily_stats.eleven_letter_extended_games_won_in_4) AS eleven_letter_extended_games_won_in_4,
    sum(_v_wordle_daily_stats.eleven_letter_extended_games_won_in_5) AS eleven_letter_extended_games_won_in_5,
    sum(_v_wordle_daily_stats.eleven_letter_extended_games_won_in_6) AS eleven_letter_extended_games_won_in_6
...
create or replace view public._v_wordle_alltime_stats as
   SELECT combined_stats.player,
    ...
    sum(combined_stats.eleven_letter_extended_games_won) AS eleven_letter_extended_games_won,
    sum(combined_stats.eleven_letter_extended_games_lost) AS eleven_letter_extended_games_lost,
    sum(combined_stats.eleven_letter_extended_games_won_in_1) AS eleven_letter_extended_games_won_in_1,
    sum(combined_stats.eleven_letter_extended_games_won_in_2) AS eleven_letter_extended_games_won_in_2,
    sum(combined_stats.eleven_letter_extended_games_won_in_3) AS eleven_letter_extended_games_won_in_3,
    sum(combined_stats.eleven_letter_extended_games_won_in_4) AS eleven_letter_extended_games_won_in_4,
    sum(combined_stats.eleven_letter_extended_games_won_in_5) AS eleven_letter_extended_games_won_in_5,
    sum(combined_stats.eleven_letter_extended_games_won_in_6) AS eleven_letter_extended_games_won_in_6
   FROM ( SELECT _v_wordle_yearly_stats.player,
            ...
            _v_wordle_yearly_stats.eleven_letter_extended_games_won,
            _v_wordle_yearly_stats.eleven_letter_extended_games_lost,
            _v_wordle_yearly_stats.eleven_letter_extended_games_won_in_1,
            _v_wordle_yearly_stats.eleven_letter_extended_games_won_in_2,
            _v_wordle_yearly_stats.eleven_letter_extended_games_won_in_3,
            _v_wordle_yearly_stats.eleven_letter_extended_games_won_in_4,
            _v_wordle_yearly_stats.eleven_letter_extended_games_won_in_5,
            _v_wordle_yearly_stats.eleven_letter_extended_games_won_in_6
        ...
        UNION ALL
         SELECT _mv_wordle_stats_2024.player,
            ...
            0 AS eleven_letter_extended_games_won,
            0 AS eleven_letter_extended_games_lost,
            0 AS eleven_letter_extended_games_won_in_1,
            0 AS eleven_letter_extended_games_won_in_2,
            0 AS eleven_letter_extended_games_won_in_3,
            0 AS eleven_letter_extended_games_won_in_4,
            0 AS eleven_letter_extended_games_won_in_5,
            0 AS eleven_letter_extended_games_won_in_6
