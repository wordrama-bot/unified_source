...
export default function PlaySpellBeeDailyPage() {
  const ref = useRef();
  //const { shareCode } = useParams();
  //const [gameReady, setGameReady] = useState(false);
  const [frameUrl, setFrameUrl] = useState(`${window.location.protocol}//${window.location.host}/spellbeegame/daily/index.html`);
  //{ !loading && gameReady && ( )}
  return (
